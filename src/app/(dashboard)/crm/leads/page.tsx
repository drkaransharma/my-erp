...
export default function LeadsPage() {
  ...
  return (
    <div>
      ...
      <LeadsTable leads={leads} onEdit={(l) => { setEditing(l); setFormOpen(true); }} />
      <LeadForm open={formOpen} onOpenChange={setFormOpen} lead={editing} companies={companies} contacts={contacts} onSave={fetchData} />
    </div>
  );
}
