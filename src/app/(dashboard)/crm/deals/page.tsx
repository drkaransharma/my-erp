...
export default function DealsPage() {
  ...
  return (
    <div>
      ...
      <DealsTable deals={deals} onEdit={(d) => { setEditing(d); setFormOpen(true); }} />
      <DealForm open={formOpen} onOpenChange={setFormOpen} deal={editing} companies={companies} contacts={contacts} onSave={fetchData} />
    </div>
  );
}
